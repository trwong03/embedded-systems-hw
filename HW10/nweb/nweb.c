//nweb.c Nigel Griffiths 2004-06-10 'A Tiny, Safe Webserver' (dead link: http://www.ibm.com/developerworks/systems/library/es-nweb/index.html)
//added comments:
//	-compiles in WSL with: "$ gcc -Wall  nweb.c -lresolv -o nweb.exe " 
//	-runs on WSL with  "$ ./nweb.exe 8811 ./ "  ( file ./index.html must be there; use a different port number for each test ) 
//	-kill with "$ ps -fu yourusername" to get nweb's PID, then "$ kill <PID>'
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <errno.h>
